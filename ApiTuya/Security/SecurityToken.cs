...
namespace ApiTuya.Security
{
    public class SecurityToken
    {
        ...
        public SecurityToken(IConfiguration configuration, ITokenRepository tokenRepository, IUserRepository userRepository, ILogger<SecurityService> logger)
        {
